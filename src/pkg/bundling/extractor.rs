use crate::pkg::bundling::utils::{
    remove_dir_all_files_predicate, validate_folder_is_empty, FolderIsEmptyValidationError,
};
...
pub enum ExtractSingleZipPackageError {
    ...
    #[error("multiple package in zip file was found when extracting single gzip package. Consider to specify package filename parameter or use extract_zip_package_to_folder method instead")]
